...
const char * const BITCOIN_CONF_FILENAME = "paxcoin.conf";
const char * const BITCOIN_PID_FILENAME = "paxcoin.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Paxcoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Paxcoin";
#else
    // Unix
    return pathRet / ".paxcoin";
#endif
#endif
}
