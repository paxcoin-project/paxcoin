...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s paxcoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  paxcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded paxcoin transaction") + "\n" +
              "  paxcoin-tx [options] -create [commands]   " + _("Create hex-encoded paxcoin transaction") + "\n" +
              "\n";
